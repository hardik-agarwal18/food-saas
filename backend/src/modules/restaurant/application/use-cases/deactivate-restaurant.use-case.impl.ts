...
import { IDeactivateRestaurantUseCase } from './deactivate-restaurant.use-case.js';
...
@injectable()
export class DeactivateRestaurantUseCaseImpl implements IDeactivateRestaurantUseCase {
  constructor(
