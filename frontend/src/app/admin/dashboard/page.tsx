...
import { useRestaurants } from '@/features/admin/restaurants/queries';
import { useApproveRestaurantMutation, useSuspendRestaurantMutation } from '@/features/admin/restaurants/mutations';
