...
import { useOrder, useOrderDriverLocation } from '@/features/customer/orders/queries';
              ...
              <Card className="overflow-hidden border-primary/20">
                ...
                <div className="h-64 w-full border-t">
                  <LiveMap 
                    ...
                    directionsDestination={order?.deliveryAddress?.latitude ? { lat: order.deliveryAddress.latitude, lng: order.deliveryAddress.longitude || 0 } : undefined}
                  />
                </div>
              </Card>
            )}
